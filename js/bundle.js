  ...
  function generateInitialBoard() {
    for (let i = 0; i < 5; i++) {
      for (let j = 2; j < 11; j++) {
        ...
        allBubbles[i][j].color = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.sample(__WEBPACK_IMPORTED_MODULE_0__colors__["a" /* default */]);
      }
    }
  }
...
// Creating a bubble
  ...
  function generateBubble() {
    if (currentBubbleColor === null) {
      ...
      currentBubbleColor = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.sample(availColors);
    }
    return {
      x: initialX,
      y: initialY,
...
const COLOR = ['Red', 'Green', 'Aqua', 'Yellow', 'Fuchsia'];
